...
public class Application {
    ...
    static OurLinkedList makeWorkersList() {

        Employee id1 = new Manager("Max", "Mustermann", 1);
        Employee id2 = new Manager("Mark", "Neumann", 2);
        Employee id3 = new Worker("Elise", "Lemann", 3);
        Employee id4 = new Worker("Kai", "Mueller", 4);
        Employee id5 = new Worker("Sabrina", "Heil", 5);
        Employee id6 = new Worker("Martin", "Baum", 6);
        Employee id7 = new Worker("Denis", "Hoffman", 6);
        ...
        workersList.append(id5);
        workersList.append(id6);
        workersList.append(id7);
    ...
    static Object task1() {
        return makeWorkersList().get(makeWorkersList().size() / 2);
    }

    static Object task2(int index) {
        return makeWorkersList().get(makeWorkersList().size() - index);
    }
